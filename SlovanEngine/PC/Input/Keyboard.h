...
private:
    ...
    static bool keyRepeated[512];
    static bool keyReleased[512];
public:
    /**
     * Return true if is key pressed (down).
     */
    static bool isPressed(int keyCode);

    /**
     * Return true if is key repeated (hold).
     */
    static bool isRepeated(int keyCode);

    /**
     * Return true if is key released (up).
     */
    static bool isReleased(int keyCode);

    /**
     * Set key of mouse button. You don't use this function!
     */
